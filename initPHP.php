...
function crearTablaProblemSet(){ // mas datos 
    ...
    while ($row=mysql_fetch_object($result)){
        ...
        //echo "dat.problemSet.tabla.body.rows[$i].row[0].link=\"problem.php?id=$row->problem_id\";";
        ...
        //echo "dat.problemSet.tabla.body.rows[$i].row[1].link=\"problem.php?id=$row->problem_id\";";
 ...
 order by pnum
	";
        ...
        while ($row=mysql_fetch_object($result)){
            ...
            //echo "dat.contest.tabla.body.rows[$i].row[0].link=\"problem.php?cid=$cid&pid=$i\";";
            ...
            //echo "dat.contest.tabla.body.rows[$i].row[1].link=\"problem.php?cid=$cid&pid=$i\";";
