...
?>
	...
	<br>Problemas:<input class=input-xxlarge type=text size=60 name=cproblem value="<?php echo isset($plist)?$plist:""?>">
	<br>
	<h4 id="annoter">Separe por una coma los PID de los problemas</h4>
	<p align=left>Descripcion:<br><!--<textarea rows=13 name=description cols=80></textarea>-->
...
?>
	Usuarios:<textarea name="ulist" rows="20" cols="20"></textarea>
	<br />
	<h4 id="annoter">Separe por "enter" salto de linea los nicks de cada usuario, si quiere que sea un evento privado</h4>
