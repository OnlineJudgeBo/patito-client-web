		...
		<form method="post" action="problem_add.php">
			...
			<p align="left" style="display: inline">Tipo de problema "Dp, Matematica, .."
				...
				<p align="left">Descripcion (<a href="https://en.wikipedia.org/wiki/Markdown"> MarkDown</a>):<br>
                    <textarea  class="input input-xxlarge"  rows=13 name="description" cols=80></textarea>				</p>

				<p align=left>Descripcion Entrada (<a href="https://en.wikipedia.org/wiki/Markdown"> MarkDown</a>):<br><
                    <textarea  class="input input-xxlarge"  rows=13 name="input" cols=80></textarea>
				</p>

			</p>
			<p align="left"> Descripcion Salida (<a href="https://en.wikipedia.org/wiki/Markdown"> MarkDown</a>):<br>
