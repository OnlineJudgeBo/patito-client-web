...
<center>
	...
	<div style="width:90%">
        ...
        <span style = "font-size:75%; margin:0 10">[<b class="top3">Top</b>] </span>
        <span style = "font-size:75%; margin:0 10">[<b class="top2">Top</b>] </span>
        <span style = "font-size:75%; margin:0 10">[<b class="top1">Top</b>] </span>
        <span style = "font-size:75%; margin:0 10">[<b class="hot">Hot</b>] </span>
        <span style = "font-size:75%; margin:0 10">[<b class="lock">Lock</b>] </span>
    </div>
</center>
<section id="foot">
