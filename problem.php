...
//echo $sql;
  ...
  if (isset($_GET['cid']) && isset($_GET['pid'])){
    ...
    if (isset($_SESSION['administrator'])||isset($_SESSION['problem_master_editor'])) $contest_ok=true;
    ...
    $view_errors="$MSG_NO_SUCH_PROBLEM</title><h2>$MSG_NO_SUCH_PROBLEM</h2>";
    require("template/".$OJ_TEMPLATE."/error.php");
    exit(0);
  }
...
//    echo $sql;
    ...
    $view_errors.= "<h4>No hay tal problema!</h4>";
  }
  require("template/".$OJ_TEMPLATE."/error.php");
  //echo $result;
  exit(0);
