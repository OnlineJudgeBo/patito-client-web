...
$sql = "SELECT * from institute_type where status = 1 ";
$institute =mysql_query($sql);
$view_institute = "";
while ($row=mysql_fetch_object($institute)){
	$view_institute .= $row->name."<input type=radio name=institute value ='".$row->institute_id."' required><br>"; 
}
/////////////////////////Template
