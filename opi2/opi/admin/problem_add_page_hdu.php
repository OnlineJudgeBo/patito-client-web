		...
		<center>
			...
			<form method=POST action=problem_add.php>
				...
				<p align=left>Description:<br>
					<textarea  class="input input-xxlarge"  rows=13 name="description" cols=80>
						<?php echo $descriptionHTML; ?>
					</textarea>
				</p>
				<p align=left>Input:<br>
					<textarea  class="input input-xxlarge"  rows=13 name="input" cols=80>
						<?php echo $inputHTML; ?>
					</textarea>
				</p>
				</p>
				<p align=left>Output:<br>
					<textarea  class="input input-xxlarge"  rows=13 name="output" cols=80>
						<?php echo $outputHTML; ?>
					</textarea>
				</p>
