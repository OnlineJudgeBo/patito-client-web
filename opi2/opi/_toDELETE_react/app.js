...
class Submit extends React.Component {
	...
	render() {
		...
		if(this.props.dat.getId!=""){			
			...
			aux=(<div>
				 <h1>Problema {this.props.dat.PID[this.props.dat.getPid]} del Concurso
	...
	render() {
		...
		if(this.props.dat.probHint)
			hint=(<div><h5 className="col s1">{this.props.msg.hint}</h5>
				  <p dangerouslySetInnerHTML={{__html: this.props.dat.probHint}}
			...
			<div className={this.props.dat.st1[localStorage.getItem("skin")]}>			  
			  ...
			  <div className="container">
				...
				<div className="z-depth-2">
				  ...
				  <p dangerouslySetInnerHTML={{__html: this.props.dat.probDes}}
				...
				<div className="z-depth-2">
				  ...
				  <p dangerouslySetInnerHTML={{__html: this.props.dat.probInput}}
					 style={{padding:"5 30 5 30"}}></p>
				</div>
				<div className="z-depth-2">
				  <div className={this.props.dat.st4[localStorage.getItem("skin")]}>
				  ...
				  <p dangerouslySetInnerHTML={{__html: this.props.dat.probOutput}}
					 style={{padding:"5 30 5 30"}}></p>
				</div>
