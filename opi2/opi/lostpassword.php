...
//  mail($lost_email,"DON'T REPLY THIS MAIL:Reset Password",'Your online judge password reset key is:'.$_SESSION['lost_key'], 'From: admin@juezpatito.cf' );
...
$mail->Password =$pas_smtp; 

$mail->AddAddress($lost_email);
$mail->Subject = "Juez de la Carrera de de Informatica";
$mail->Body = "Tu contraseña de reinicio es :".$_SESSION['lost_key'];
