<footer class="bg-white p-4 mt-6 border-t border-gray-200">
    <div class="container mx-auto text-center text-gray-800">
        <p>Si eres profesor y necesitas más información para tu institución, no dudes en escribir a:
        ...
        <p>O a través de Telegram:
            <a href="https://t.me/zsams" class="text-blue-300 hover:text-blue-500">@zsams</a>
        </p>
    </div>
</footer>