            ...
            <div class="max-w-lg mx-auto mt-10 bg-white p-8 border border-gray-200 rounded-lg shadow-lg">
                <form id="registrationForm" method="POST" action="registerpage.php">
                    ...
                    <div class="mb-4">
                        ...
                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500" name="email2" id="email2" type="email2" placeholder="tucorreo@ejemplo.com" required>
                    </div>
                    <div class="mb-4">
                ...
                .then(response => {
                    if (response.ok) {
                        Swal.fire({
                            ...
                            text: 'Usuario registrado correctamente. Se ha enviado un correo electrónico; revise la carpeta de SPAM. Por favor, inicie sesión.',
                            timer: 3000,
                            timerProgressBar: true,
                            didClose: () => {
                                window.location.href = "login.php";
