...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-ZRPBZ3Q80F"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-ZRPBZ3Q80F');
</script>
...
<nav class="w-full bg-slate-900 border-b-4 border-green-700 bg-gradient-to-r from-bg-slate-600 to-bg-slate-700">
      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start text-custom-blue ">
        ...
        <div class="hidden sm:ml-6 sm:block">
          <div class="flex space-x-4 pt-2">
            ...
            <a href="contest.php?cid=<?php echo $cid ?>" class="text-xl text-white hover:text-yellow-400 rounded-md px-3 py-2 text-sm font-medium">Problemas</a>
            <a href="contestrank.php?cid=<?php echo $cid ?>" class="text-xl text-white hover:text-yellow-400 rounded-md px-3 py-2 text-sm font-medium">Ranking</a>
            <a href="status.php?cid=<?php echo $cid ?>" class="text-xl text-white hover:text-yellow-400 rounded-md px-3 py-2 text-sm font-medium">Envios</a>
          </div>
        </div>
      </div>
  ...
  <div class="sm:hidden hidden" id="mobile-menu">
    <div class="space-y-1 px-2 pb-3 pt-2">
      ...
      <a href="contest.php?cid=<?php echo $cid ?>" class="text-white hover:text-yellow-400 block rounded-md px-3 py-2 text-base font-medium">Problemas</a>
      <a href="contestrank.php?cid=<?php echo $cid ?>" class="text-white hover:text-yellow-400 block rounded-md px-3 py-2 text-base font-medium">Ranking</a>
      <a href="status.php?cid=<?php echo $cid ?>" class="text-white hover:text-yellow-400 block rounded-md px-3 py-2 text-base font-medium">Envios</a>
      <?php include __DIR__ . '/partials/user-session-menu.php'; ?>
    </div>
  </div>
</nav>
