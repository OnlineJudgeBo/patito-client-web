<nav class="bg-white p-4 shadow-md border-b border-gray-200">
    ...
    <a href="#" class="flex items-center gap-2 text-lg font-semibold text-black">
        <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <polyline points="16 18 22 12 16 6" />
          <polyline points="8 6 2 12 8 18" />
        </svg>
        <span>Juez Virtual Bo</span>
      </a>
        <div class="flex items-center space-x-4 hidden md:flex">
            ...
            <a href="status.php" class="text-gray-800 hover:text-blue-200">Envíos</a>
    ...
    <div id="mobile-menu" class="md:hidden hidden">
        ...
        <a href="status.php" class="block px-4 py-2 text-gray-800 hover:bg-gray-100">Envíos</a>
