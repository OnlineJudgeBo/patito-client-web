<html>
	<head>
		...
		<script>load("materialize");</script>
    </head>
    <body>
			...
			<div id=main>
				...
				<center><table><tr><td>
					...
					<?php }?>
							...
							<?php
							echo "<a href='problemstatistics.php?id=$id'>[TOP]</a>";
							echo "&nbsp;&nbsp;<a href='status.php?problem_id=$id'>[STATUS]</a>";
							if ($page>$pagemin){
								$page--;
								echo "&nbsp;&nbsp;<a href='problemstatistics.php?id=$id&page=$page'>[PREV]</a>";
								$page++;
							}
							if ($page<$pagemax){
								$page++;
								echo "&nbsp;&nbsp;<a href='problemstatistics.php?id=$id&page=$page'>[NEXT]</a>";
								$page--;
							}
