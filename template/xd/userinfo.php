...
<body>
      ...
      <center>
       <table class="table table-striped" id="statics" width="70%">
        <caption>
         ...
         <?php
         echo "<a href=mail.php?to_user=$user> <img src='template/$OJ_TEMPLATE/image/correo.png'>$MSG_MAIL </a>";
         ?>
       </caption>
       <tr bgcolor="#D7EBFF"><td width="15%"><?php echo $MSG_Number?><td width=25% align=center><?php echo $Rank?><td width=70% align=center>Problemas Resueltos</tr>
    ...
    <tr bgcolor=#D7EBFF><td><?php echo "Enviados"?><td align=center><a href='status.php?user_id=<?php echo $user?>'><?php echo $Submit?></a></tr>
    <?php 
...
<tr bgcolor="#D7EBFF"><td>Institucion:<td align=center><?php echo $school?></tr>
<tr bgcolor="#D7EBFF"><td>Correo:<td align="center"><?php echo $email?></tr>
</table>
<?php
