  ...
  <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
    <div class="relative flex h-16 items-center justify-between ">
      <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
        <!-- Mobile menu button-->
        <button type="button" class="relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:text-yellow-400 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start text-custom-blue ">
        <div class="flex flex-shrink-0 items-center">
          <img class="h-16 w-auto" src="./statics/ZaDuckOJ/logo.svg" alt="Juez Virtual Patito">
        </div>
      ...
      <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        <div class="flex space-x-4">
          <a href="#" class="text-xl text-white hover:text-yellow-400 rounded-md px-3 py-2 text-sm font-medium">Inicia
            sesión</a>
          <a href="#" class="text-xl text-white hover:text-yellow-400 rounded-md px-3 py-2 text-sm font-medium">Registrarse</a>
        </div>
      </div>
    </div>
  </div>
