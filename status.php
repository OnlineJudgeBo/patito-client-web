...
for ($i = 0; $i < $rows_cnt; $i++) {
	...
	//echo $row['result'];
	if (!(isset($_SESSION['user_id']) && strtolower($row['user_id']) == strtolower($_SESSION['user_id']) || isset($_SESSION['source_browser']) or $_SESSION['user_id'] == 'starsaminf')) {
